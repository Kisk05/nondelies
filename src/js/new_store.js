function loadStoreInfo() {
    ...
    const apiURL = `/php/get_storeinfo.php?sup_id=${supId}&sto_id=${stoId}`;
...
async function fetchnewstore() {
    ...
    const apiURL = `/php/get_zahyou.php?address=${stoAddress}`;
    ...
    try {
        ...
        if (data.status === 'success') 
        {
            ...
            const setApiURL = `/php/new_store.php?sup_id=${supId}&sto_name=${stoName}&sto_postcode=${stoPostcode}&sto_address=${stoAddress}&sto_latitude=${stoLat}&sto_longitude=${stoLon}`;
...
async function changestore() {
    ...
    try {
        ...
        if (data.status === 'success') 
        {
            ...
            const setApiURL = `/php/change_store.php?sto_id=${stoId}&sup_id=${supId}&sto_name=${stoName}&sto_postcode=${stoPostcode}&sto_address=${stoAddress}&sto_latitude=${stoLat}&sto_longitude=${stoLon}`;
